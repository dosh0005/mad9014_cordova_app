...
function set_image(name) {
    ...
    case 'Kolkata Knight Riders':
        img.setAttribute("src", "img/kkr.svg");
        break;
    case 'Royal Challengers Bangalore':
        img.setAttribute("src", "img/rcb.svg");
        break;
    case 'Mumbai Indians':
        img.setAttribute("src", "img/mi.svg");
        break;
    case 'Sunrisers Hyderabad':
        img.setAttribute("src", "img/sh.svg");
        break;
    case 'Kings XI Punjab':
        img.setAttribute("src", "img/kxip.svg");
        break;
    case 'Gujarat Lions':
        img.setAttribute("src", "img/gl.svg");
        break;
    case 'Delhi Daredevils':
        img.setAttribute("src", "img/dd.svg");
        break;
    case 'Rising Pune Supergiants':
        img.setAttribute("src", "img/rps.svg");
        break;
    }
